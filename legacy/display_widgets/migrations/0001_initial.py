...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'display_widgets.dashboardwidget': {
            'Meta': {'object_name': 'DashboardWidget'},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customers.Collection']", 'null': 'True'}),
            'column': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indexes.Index']", 'null': 'True'}),
            'row': ('django.db.models.fields.IntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.User']"}),
            'widget_type': ('django.db.models.fields.IntegerField', [], {})
        },
        u'indexes.index': {
