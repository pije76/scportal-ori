...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meter.hardware_id'
        db.add_column(u'devices_meter', 'hardware_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meter.hardware_id'
        db.delete_column(u'devices_meter', 'hardware_id')
    ...
    models = {
        ...
        u'devices.agentevent': {
            'Meta': {'ordering': "[u'timestamp']", 'object_name': 'AgentEvent'},
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Agent']"}),
            'code': ('django.db.models.fields.SmallIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {})
        },
        u'devices.agentstatechange': {
            'Meta': {'object_name': 'AgentStateChange'},
            'add_mode': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Agent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'online': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'devices.meterstatechange': {
            'Meta': {'object_name': 'MeterStateChange'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manual_mode': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'meter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Meter']"}),
            'online': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'relay_on': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {})
        },
        ...
        u'devices.softwareimage': {
            'Meta': {'ordering': "[u'device_type', u'hw_major', u'hw_minor', u'hw_revision', u'hw_subrevision', u'sw_major', u'sw_minor', u'sw_revision', u'sw_subrevision']", 'object_name': 'SoftwareImage'},
            'device_type': ('django.db.models.fields.IntegerField', [], {}),
            'hw_major': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'hw_minor': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'hw_revision': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'hw_subrevision': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sw_major': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'sw_minor': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'sw_revision': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'sw_subrevision': ('django.db.models.fields.CharField', [], {'max_length': '12'})
        },
