...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'energinet_co2.modelbinding': {
            'Meta': {'object_name': 'ModelBinding'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'to': u"orm['indexes.Index']"})
        },
        u'indexes.index': {
