...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'manage_collections.collectionitem': {
            'Meta': {'object_name': 'CollectionItem', '_ormbases': [u'manage_collections.Item']},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customers.Collection']"}),
            u'item_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['manage_collections.Item']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'manage_collections.floorplan': {
            'Meta': {'object_name': 'Floorplan'},
            'collection': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['customers.Collection']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '100'})
        },
        u'manage_collections.infoitem': {
            'Meta': {'object_name': 'InfoItem', '_ormbases': [u'manage_collections.Item']},
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            'info': ('gridplatform.encryption.fields.EncryptedTextField', [], {}),
            u'item_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['manage_collections.Item']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'manage_collections.item': {
            'Meta': {'object_name': 'Item'},
            'floorplan': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['manage_collections.Floorplan']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subclass': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['contenttypes.ContentType']"}),
    ...
    complete_apps = ['manage_collections']