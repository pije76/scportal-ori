...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'indexes.datasourceindexadapter': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'DataSourceIndexAdapter', '_ormbases': [u'indexes.Index']},
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datasources.DataSource']"}),
            u'index_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['indexes.Index']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'indexes.derivedindexperiod': {
            'Meta': {'ordering': "[u'from_date']", 'object_name': 'DerivedIndexPeriod'},
            'coefficient': ('django.db.models.fields.DecimalField', [], {'default': "'1.000'", 'max_digits': '10', 'decimal_places': '5'}),
            'constant': ('django.db.models.fields.DecimalField', [], {'default': "'0.000'", 'max_digits': '10', 'decimal_places': '5'}),
            'from_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indexes.Index']"}),
            'other_index': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'period_derivative_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['indexes.Index']"}),
            'roof': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'})
        },
        u'indexes.entry': {
            'Meta': {'ordering': "[u'from_timestamp']", 'unique_together': "((u'index', u'from_timestamp'), (u'index', u'to_timestamp'))", 'object_name': 'Entry'},
            'from_timestamp': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indexes.Index']"}),
            'to_timestamp': ('django.db.models.fields.DateTimeField', [], {}),
            'value': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'})
        },
        u'indexes.index': {
        ...
        u'indexes.seasonindexperiod': {
            'Meta': {'object_name': 'SeasonIndexPeriod'},
            'from_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indexes.Index']"}),
            'value_at_hour_0': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_1': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_10': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_11': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_12': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_13': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_14': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_15': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_16': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_17': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_18': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_19': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_2': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_20': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_21': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_22': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_23': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_3': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_4': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_5': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_6': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_7': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_8': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
            'value_at_hour_9': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'})
        },
        u'indexes.spotmapping': {
            'Meta': {'ordering': "[u'area', u'unit']", 'object_name': 'SpotMapping'},
            'area': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['indexes.Index']", 'unique': 'True'}),
            'timezone': ('timezones2.models.TimeZoneField', [], {'max_length': '64'}),
            'unit': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'})
        },
        u'indexes.standardmonthindex': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'StandardMonthIndex', '_ormbases': [u'indexes.Index']},
            'april': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'august': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'december': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'february': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            u'index_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['indexes.Index']", 'unique': 'True', 'primary_key': 'True'}),
            'january': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'july': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'june': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'march': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'may': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'november': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'october': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'september': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'})
        },
