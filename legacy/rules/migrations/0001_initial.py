...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'indexes.index': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'Index', '_ormbases': [u'measurementpoints.DataSeries']},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customers.Collection']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'data_format': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '100'}),
            'timezone': ('timezones2.models.TimeZoneField', [], {'default': 'None', 'max_length': '64'})
        },
        ...
        u'rules.dateexception': {
            'Meta': {'ordering': "[u'-to_date', u'-from_date', u'id']", 'object_name': 'DateException'},
            'from_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rule': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rules.UserRule']"}),
            'to_date': ('django.db.models.fields.DateField', [], {})
        },
        u'rules.emailaction': {
            'Meta': {'ordering': "[u'message', u'id']", 'object_name': 'EmailAction'},
            'execution_time': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'recipient': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'rule': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rules.UserRule']"})
        },
        u'rules.indexinvariant': {
            'Meta': {'object_name': 'IndexInvariant'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indexes.Index']", 'on_delete': 'models.PROTECT'}),
            'operator': ('django.db.models.fields.IntegerField', [], {}),
            'rule': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rules.TriggeredRule']"}),
            'unit': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'value': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '3'})
        },
        u'rules.inputinvariant': {
            'Meta': {'object_name': 'InputInvariant'},
        ...
        u'rules.minimizerule': {
            'Meta': {'ordering': "[u'-to_time', u'-from_time', u'-enabled', u'id']", 'object_name': 'MinimizeRule', '_ormbases': [u'rules.UserRule']},
            'activity_duration': ('gridplatform.utils.fields.DurationField', [], {}),
            'consecutive': ('django.db.models.fields.BooleanField', [], {}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indexes.Index']", 'on_delete': 'models.PROTECT'}),
            u'userrule_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['rules.UserRule']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'rules.phoneaction': {
            'Meta': {'ordering': "[u'phone_number', u'message', u'id']", 'object_name': 'PhoneAction'},
            'execution_time': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {}),
        ...
        u'rules.relayaction': {
            'Meta': {'ordering': "[u'id']", 'object_name': 'RelayAction'},
            'execution_time': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Meter']", 'on_delete': 'models.PROTECT'}),
            'relay_action': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'rule': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rules.UserRule']"})
        },
        u'rules.triggeredrule': {
            'Meta': {'ordering': "[u'-to_time', u'-from_time', u'-enabled', u'id']", 'object_name': 'TriggeredRule', '_ormbases': [u'rules.UserRule']},
            u'userrule_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['rules.UserRule']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'rules.userrule': {
            'Meta': {'ordering': "[u'-to_time', u'-from_time', u'-enabled', u'id']", 'object_name': 'UserRule'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']", 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            'friday': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'from_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'timezone': ('timezones2.models.TimeZoneField', [], {'default': 'None', 'max_length': '64'}),
            'to_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(0, 0)'}),
