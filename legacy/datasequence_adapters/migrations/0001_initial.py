...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'datasequence_adapters.consumptionaccumulationadapter': {
            'Meta': {'object_name': 'ConsumptionAccumulationAdapter'},
            'datasequence': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['consumptions.Consumption']"}),
        ...
        u'datasequence_adapters.nonaccumulationadapter': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'NonaccumulationAdapter', '_ormbases': [u'measurementpoints.DataSeries']},
            'datasequence': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['datasequences.NonaccumulationDataSequence']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'datasequence_adapters.productionaccumulationadapter': {
            'Meta': {'object_name': 'ProductionAccumulationAdapter'},
            'datasequence': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['productions.Production']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'})
        },
    ...
    complete_apps = ['datasequence_adapters']