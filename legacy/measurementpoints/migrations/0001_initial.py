...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'measurementpoints.chain': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'Chain', '_ormbases': [u'measurementpoints.DataSeries']},
            'chained_data_series': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'chain_derivative_set'", 'symmetrical': 'False', 'through': u"orm['measurementpoints.ChainLink']", 'to': u"orm['measurementpoints.DataSeries']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'measurementpoints.chainlink': {
            'Meta': {'ordering': "[u'valid_from']", 'unique_together': "((u'chain', u'valid_from'),)", 'object_name': 'ChainLink'},
            'chain': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'links'", 'to': u"orm['measurementpoints.Chain']"}),
            'data_series': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'chainlink_data_series'", 'on_delete': 'models.PROTECT', 'to': u"orm['measurementpoints.DataSeries']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'None'})
        },
        ...
        u'measurementpoints.degreedaycorrection': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'DegreeDayCorrection', '_ormbases': [u'measurementpoints.DataSeries']},
            'consumption': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'degreedayscorrectionconsumption_derivative_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['measurementpoints.DataSeries']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'}),
            'degreedays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'degreedayscorrectiondegreedaysn_derivative_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['measurementpoints.DataSeries']"}),
            'standarddegreedays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'degreedayscorrectionstandardegreedays_derivative_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['measurementpoints.DataSeries']"})
        },
        ...
        u'measurementpoints.heatingdegreedays': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'HeatingDegreeDays', '_ormbases': [u'measurementpoints.DataSeries']},
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'}),
            'derived_from': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'heatingdegreedays_derivative_set'", 'to': u"orm['measurementpoints.DataSeries']"})
        },
        u'measurementpoints.indexcalculation': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'IndexCalculation', '_ormbases': [u'measurementpoints.DataSeries']},
            'consumption': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'indexcalculation_consumption_derivative_set'", 'to': u"orm['measurementpoints.DataSeries']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'indexcalculation_derivative_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['measurementpoints.DataSeries']"})
        },
        u'measurementpoints.link': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'Link', '_ormbases': [u'measurementpoints.DataSeries']},
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'link_derivative_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['measurementpoints.DataSeries']"})
        },
        u'measurementpoints.meantemperaturechange': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'MeanTemperatureChange', '_ormbases': [u'measurementpoints.DataSeries']},
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'}),
            'energy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'mean_temperature_change_energy_derivative_set'", 'to': u"orm['measurementpoints.DataSeries']"}),
            'volume': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'mean_temperature_change_volume_derivative_set'", 'to': u"orm['measurementpoints.DataSeries']"})
        },
        u'measurementpoints.multiplication': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'Multiplication', '_ormbases': [u'measurementpoints.DataSeries']},
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'}),
            'multiplier': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'source_data_series': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'multiplied_data_series_derivative_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['measurementpoints.DataSeries']"})
        },
        u'measurementpoints.piecewiseconstantintegral': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'PiecewiseConstantIntegral', '_ormbases': [u'measurementpoints.DataSeries']},
            'data': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'piecewise_constant_integrals_set'", 'to': u"orm['measurementpoints.DataSeries']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'measurementpoints.rateconversion': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'RateConversion', '_ormbases': [u'measurementpoints.DataSeries']},
            'consumption': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'rate_conversion_derivative_set'", 'to': u"orm['measurementpoints.DataSeries']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'measurementpoints.simplelinearregression': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'SimpleLinearRegression', '_ormbases': [u'measurementpoints.DataSeries']},
            'data': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'simple_linear_regression'", 'to': u"orm['measurementpoints.DataSeries']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'measurementpoints.storeddata': {
            'Meta': {'ordering': "[u'timestamp']", 'unique_together': "((u'data_series', u'timestamp'),)", 'object_name': 'StoredData', 'index_together': "[[u'data_series', u'timestamp']]"},
            'data_series': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'stored_data'", 'to': u"orm['measurementpoints.DataSeries']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {}),
            'value': ('django.db.models.fields.BigIntegerField', [], {})
        },
        u'measurementpoints.summation': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'Summation', '_ormbases': [u'measurementpoints.DataSeries']},
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'}),
            'included_data_series': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'summation_derivative_set'", 'symmetrical': 'False', 'through': u"orm['measurementpoints.SummationTerm']", 'to': u"orm['measurementpoints.DataSeries']"})
        },
        u'measurementpoints.summationterm': {
            'Meta': {'object_name': 'SummationTerm'},
            'data_series': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['measurementpoints.DataSeries']", 'on_delete': 'models.PROTECT'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sign': ('django.db.models.fields.IntegerField', [], {}),
            'summation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'terms'", 'to': u"orm['measurementpoints.Summation']"})
        },
        u'measurementpoints.utilization': {
            'Meta': {'ordering': "[u'role', u'id']", 'object_name': 'Utilization', '_ormbases': [u'measurementpoints.DataSeries']},
            'consumption': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'utilization_consumption_derivative_set'", 'to': u"orm['measurementpoints.DataSeries']"}),
            u'dataseries_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['measurementpoints.DataSeries']", 'unique': 'True', 'primary_key': 'True'}),
            'needs': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'utilization_needs_derivative_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['measurementpoints.DataSeries']"})
        },
    ...
    complete_apps = ['measurementpoints']