...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'projects.additionalsaving': {
            'Meta': {'object_name': 'AdditionalSaving'},
            'after_co2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '6', 'blank': 'True'}),
            'after_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'after_energy': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'before_co2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '6', 'blank': 'True'}),
            'before_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'before_energy': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'description': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '50'}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            'energy_unit': ('django.db.models.fields.CharField', [], {'default': "u'kilowatt*hour'", 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.BenchmarkProject']"})
        },
        u'projects.benchmarkproject': {
            'Meta': {'object_name': 'BenchmarkProject'},
            'actions': ('gridplatform.encryption.fields.EncryptedTextField', [], {'blank': 'True'}),
            'background': ('gridplatform.encryption.fields.EncryptedTextField', [], {'blank': 'True'}),
            'baseline_from_timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'baseline_measurement_points': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'benchmarkproject_baseline_member'", 'blank': 'True', 'to': u"orm['customers.MeasurementPoint']"}),
            'baseline_to_timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'comments': ('gridplatform.encryption.fields.EncryptedTextField', [], {'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']", 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            'estimated_co2_emissions_before': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'estimated_yearly_consumption_before': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'estimated_yearly_consumption_costs_before': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'expectations': ('gridplatform.encryption.fields.EncryptedTextField', [], {'blank': 'True'}),
            'expected_reduction_in_yearly_co2_emissions': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '2'}),
            'expected_savings_in_yearly_consumption_after': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '2'}),
            'expected_savings_in_yearly_total_costs': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'include_measured_costs': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '50'}),
            'result': ('gridplatform.encryption.fields.EncryptedTextField', [], {'blank': 'True'}),
            'result_from_timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'result_measurement_points': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'benchmarkproject_result_member'", 'blank': 'True', 'to': u"orm['customers.MeasurementPoint']"}),
            'result_to_timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'runtime': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'subsidy': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'utility_type': ('django.db.models.fields.IntegerField', [], {})
        },
        u'projects.cost': {
            'Meta': {'object_name': 'Cost'},
            'amortization_period': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cost': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '2'}),
            'description': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '50'}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest_rate': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.BenchmarkProject']"}),
            'scrap_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'})
        },
