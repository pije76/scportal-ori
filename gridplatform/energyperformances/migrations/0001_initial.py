...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'consumptions.consumptiongroup': {
            'Meta': {'object_name': 'ConsumptionGroup'},
            'consumptions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['consumptions.Consumption']", 'symmetrical': 'False', 'blank': 'True'}),
            'cost_compensation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cost_compensations.CostCompensation']", 'null': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'description': ('gridplatform.encryption.fields.EncryptedTextField', [], {'blank': 'True'}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            'from_date': ('django.db.models.fields.DateField', [], {'default': 'None'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mainconsumption': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['consumptions.MainConsumption']"}),
        ...
        u'consumptions.mainconsumption': {
            'Meta': {'object_name': 'MainConsumption'},
            'consumptions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['consumptions.Consumption']", 'symmetrical': 'False', 'blank': 'True'}),
            'cost_compensation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cost_compensations.CostCompensation']", 'null': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'description': ('gridplatform.encryption.fields.EncryptedTextField', [], {'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '100'}),
            'tariff': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tariffs.Tariff']", 'null': 'True', 'blank': 'True'}),
            'to_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'cost_compensations.costcompensation': {
            'Meta': {'object_name': 'CostCompensation'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '200'}),
        ...
        u'energyperformances.energyperformance': {
            'Meta': {'object_name': 'EnergyPerformance'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'description': ('gridplatform.encryption.fields.EncryptedTextField', [], {}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '255'}),
            'subclass': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['contenttypes.ContentType']"})
        },
        u'energyperformances.productionenergyperformance': {
            'Meta': {'object_name': 'ProductionEnergyPerformance', '_ormbases': [u'energyperformances.EnergyPerformance']},
            'consumptiongroups': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['consumptions.ConsumptionGroup']", 'symmetrical': 'False', 'blank': 'True'}),
            u'energyperformance_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['energyperformances.EnergyPerformance']", 'unique': 'True', 'primary_key': 'True'}),
            'production_unit': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'}),
            'productiongroups': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['productions.ProductionGroup']", 'symmetrical': 'False', 'blank': 'True'})
        },
        u'energyperformances.timeenergyperformance': {
            'Meta': {'object_name': 'TimeEnergyPerformance', '_ormbases': [u'energyperformances.EnergyPerformance']},
            'consumptiongroups': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['consumptions.ConsumptionGroup']", 'symmetrical': 'False', 'blank': 'True'}),
            u'energyperformance_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['energyperformances.EnergyPerformance']", 'unique': 'True', 'primary_key': 'True'}),
            'unit': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'})
        },
        ...
        u'productions.productiongroup': {
            'Meta': {'object_name': 'ProductionGroup'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'description': ('gridplatform.encryption.fields.EncryptedTextField', [], {'blank': 'True'}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '100'}),
            'productions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['productions.Production']", 'symmetrical': 'False', 'blank': 'True'}),
            'unit': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'})
        },
    ...
    complete_apps = ['energyperformances']