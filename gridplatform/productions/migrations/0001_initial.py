...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'productions.nonpulseperiod': {
            'Meta': {'object_name': 'NonpulsePeriod', '_ormbases': [u'productions.Period']},
            ...
            u'period_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['productions.Period']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'productions.offlinetolerance': {
            'Meta': {'object_name': 'OfflineTolerance'},
            'datasequence': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['productions.Production']", 'unique': 'True'}),
            'hours': ('django.db.models.fields.PositiveIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'productions.period': {
            'Meta': {'object_name': 'Period'},
            'datasequence': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['productions.Production']"}),
        ...
        u'productions.pulseperiod': {
            'Meta': {'object_name': 'PulsePeriod', '_ormbases': [u'productions.Period']},
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['datasources.DataSource']"}),
        ...
        u'productions.singlevalueperiod': {
            'Meta': {'object_name': 'SingleValuePeriod', '_ormbases': [u'productions.Period']},
            u'period_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['productions.Period']", 'unique': 'True', 'primary_key': 'True'}),
            'unit': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'}),
