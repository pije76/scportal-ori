...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatahubConnection'
        db.create_table(u'datahub_datahubconnection', (
            ...
            ('meter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Meter'], on_delete=models.PROTECT)),
            ('input', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.PhysicalInput'], on_delete=models.PROTECT)),
            ('customer_meter_number', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('authorization_id', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
        ))
        db.send_create_signal(u'datahub', ['DatahubConnection'])


    def backwards(self, orm):
        # Deleting model 'DatahubConnection'
        db.delete_table(u'datahub_datahubconnection')
    ...
    models = {
        ...
        u'customer_datasources.customerdatasource': {
            'Meta': {'object_name': 'CustomerDataSource', '_ormbases': [u'datasources.DataSource']},
        ...
        u'datahub.datahubconnection': {
            'Meta': {'object_name': 'DatahubConnection'},
            'authorization_id': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'customer_meter_number': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            'end_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.PhysicalInput']", 'on_delete': 'models.PROTECT'}),
            'meter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Meter']", 'on_delete': 'models.PROTECT'}),
            'start_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'unit': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'})
        },
        ...
        u'devices.physicalinput': {
            'Meta': {'ordering': "[u'order', u'type']", 'object_name': 'PhysicalInput', '_ormbases': [u'customer_datasources.CustomerDataSource']},
            u'customerdatasource_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['customer_datasources.CustomerDataSource']", 'unique': 'True', 'primary_key': 'True'}),
            'meter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Meter']", 'on_delete': 'models.PROTECT'}),
            'order': ('django.db.models.fields.IntegerField', [], {}),
            'store_measurements': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
