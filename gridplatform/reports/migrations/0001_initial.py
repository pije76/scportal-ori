...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'reports.report': {
            'Meta': {'ordering': "[u'generation_time', u'data_format', u'id']", 'object_name': 'Report'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customers.Customer']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            'data': ('gridplatform.encryption.fields.EncryptedTextField', [], {}),
            'data_format': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            'generation_time': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
