...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'cost_compensations.fixedcompensationperiod': {
            'Meta': {'object_name': 'FixedCompensationPeriod', '_ormbases': [u'cost_compensations.Period']},
            u'period_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['cost_compensations.Period']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'cost_compensations.period': {
            'Meta': {'object_name': 'Period'},
            'datasequence': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cost_compensations.CostCompensation']"}),
    ...
    complete_apps = ['cost_compensations']