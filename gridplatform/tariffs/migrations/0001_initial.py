...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'tariffs.fixedpriceperiod': {
            'Meta': {'object_name': 'FixedPricePeriod', '_ormbases': [u'tariffs.Period']},
            u'period_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tariffs.Period']", 'unique': 'True', 'primary_key': 'True'}),
            'subscription_fee': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '3'}),
            'subscription_period': ('django.db.models.fields.IntegerField', [], {}),
            'unit': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'}),
            'value': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '3'})
        },
        u'tariffs.period': {
            'Meta': {'ordering': "(u'from_timestamp',)", 'object_name': 'Period'},
            'datasequence': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tariffs.Tariff']"}),
        ...
        u'tariffs.spotpriceperiod': {
            'Meta': {'object_name': 'SpotPricePeriod', '_ormbases': [u'tariffs.Period']},
            'ceiling': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '3', 'blank': 'True'}),
            'coefficient': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '3'}),
            'constant': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '3'}),
            u'period_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tariffs.Period']", 'unique': 'True', 'primary_key': 'True'}),
            'spotprice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datasources.DataSource']"}),
            'subscription_fee': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '3'}),
            'subscription_period': ('django.db.models.fields.IntegerField', [], {}),
            'unit_for_constant_and_ceiling': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'})
        },
        u'tariffs.tariff': {
        ...
        u'tariffs.volumetariff': {
            'Meta': {'object_name': 'VolumeTariff', '_ormbases': [u'tariffs.Tariff']},
            u'tariff_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tariffs.Tariff']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'users.user': {
