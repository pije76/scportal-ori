...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'consumptions.nonpulseperiod': {
            'Meta': {'object_name': 'NonpulsePeriod', '_ormbases': [u'consumptions.Period']},
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['datasources.DataSource']"}),
            u'period_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['consumptions.Period']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'consumptions.offlinetolerance': {
            'Meta': {'object_name': 'OfflineTolerance'},
            'datasequence': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['consumptions.Consumption']", 'unique': 'True'}),
            'hours': ('django.db.models.fields.PositiveIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'consumptions.period': {
            'Meta': {'object_name': 'Period'},
            'datasequence': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['consumptions.Consumption']"}),
        ...
        u'consumptions.pulseperiod': {
            'Meta': {'object_name': 'PulsePeriod', '_ormbases': [u'consumptions.Period']},
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['datasources.DataSource']"}),
            'output_quantity': ('django.db.models.fields.IntegerField', [], {}),
            'output_unit': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'}),
            u'period_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['consumptions.Period']", 'unique': 'True', 'primary_key': 'True'}),
            'pulse_quantity': ('django.db.models.fields.IntegerField', [], {})
        },
        u'consumptions.singlevalueperiod': {
            'Meta': {'object_name': 'SingleValuePeriod', '_ormbases': [u'consumptions.Period']},
            u'period_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['consumptions.Period']", 'unique': 'True', 'primary_key': 'True'}),
            'unit': ('gridplatform.utils.fields.BuckinghamField', [], {'max_length': '100'}),
