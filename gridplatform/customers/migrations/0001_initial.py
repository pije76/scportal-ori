...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'customers.collectionconstraint': {
            'Meta': {'object_name': 'CollectionConstraint', 'db_table': "u'customers_userprofile_collections'"},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customers.Collection']", 'on_delete': 'models.PROTECT'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'userprofile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customers.UserProfile']"})
        },
        ...
        u'customers.userprofile': {
            'Meta': {'ordering': "[u'id']", 'object_name': 'UserProfile'},
            'collections': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['customers.Collection']", 'through': u"orm['customers.CollectionConstraint']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
