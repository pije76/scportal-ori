...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'co2conversions.co2conversion': {
            'Meta': {'object_name': 'Co2Conversion'},
        ...
        u'co2conversions.dynamicco2conversion': {
            'Meta': {'object_name': 'DynamicCo2Conversion', '_ormbases': [u'co2conversions.Co2Conversion']},
            u'co2conversion_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['co2conversions.Co2Conversion']", 'unique': 'True', 'primary_key': 'True'}),
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datasources.DataSource']"})
        },
        u'co2conversions.fixedco2conversion': {
            'Meta': {'object_name': 'FixedCo2Conversion', '_ormbases': [u'co2conversions.Co2Conversion']},
            u'co2conversion_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['co2conversions.Co2Conversion']", 'unique': 'True', 'primary_key': 'True'}),
