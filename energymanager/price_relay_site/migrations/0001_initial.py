...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PriceRelayProject'
        db.create_table(u'price_relay_site_pricerelayproject', (
            ...
            ('look_ahead', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('relay_one_on_at', self.gf('django.db.models.fields.FloatField')()),
            ('relay_two_on_at', self.gf('django.db.models.fields.FloatField')()),
            ('relay_tree_on_at', self.gf('django.db.models.fields.FloatField')()),
            ('relay_four_on_at', self.gf('django.db.models.fields.FloatField')()),
            ('relay_five_on_at', self.gf('django.db.models.fields.FloatField')()),
            ('relay_six_on_at', self.gf('django.db.models.fields.FloatField')()),
            ('relay_seven_on_at', self.gf('django.db.models.fields.FloatField')()),
            ('relay_eight_on_at', self.gf('django.db.models.fields.FloatField')()),
            ('tariff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tariffs.EnergyTariff'])),
        ))
        db.send_create_signal(u'price_relay_site', ['PriceRelayProject'])


    def backwards(self, orm):
        # Deleting model 'PriceRelayProject'
        db.delete_table(u'price_relay_site_pricerelayproject')
    ...
    models = {
        ...
        u'price_relay_site.pricerelayproject': {
            'Meta': {'object_name': 'PriceRelayProject'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'look_ahead': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '50'}),
            'relay_eight_on_at': ('django.db.models.fields.FloatField', [], {}),
            'relay_five_on_at': ('django.db.models.fields.FloatField', [], {}),
            'relay_four_on_at': ('django.db.models.fields.FloatField', [], {}),
            'relay_one_on_at': ('django.db.models.fields.FloatField', [], {}),
            'relay_seven_on_at': ('django.db.models.fields.FloatField', [], {}),
            'relay_six_on_at': ('django.db.models.fields.FloatField', [], {}),
            'relay_tree_on_at': ('django.db.models.fields.FloatField', [], {}),
            'relay_two_on_at': ('django.db.models.fields.FloatField', [], {}),
            'tariff': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tariffs.EnergyTariff']"})
        },
        ...
        u'tariffs.energytariff': {
            'Meta': {'object_name': 'EnergyTariff', '_ormbases': [u'tariffs.Tariff']},
            u'tariff_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tariffs.Tariff']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'tariffs.tariff': {
    ...
    complete_apps = ['price_relay_site']