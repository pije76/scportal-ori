...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnergyProject'
        db.create_table(u'energy_projects_energyproject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('encryption_data_initialization_vector', self.gf('gridplatform.encryption.fields.Base64Field')()),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['customers.Customer'])),
            ('name', self.gf('gridplatform.encryption.fields.EncryptedCharField')(max_length=50)),
            ('baseline_from_date', self.gf('django.db.models.fields.DateField')()),
            ('baseline_to_date', self.gf('django.db.models.fields.DateField')()),
            ('time_datasource', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'energyproject_time_set', null=True, to=orm['consumptions.Consumption'])),
            ('datasource', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'energyproject_set', null=True, to=orm['consumptions.Consumption'])),
            ('result_from_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('result_to_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'energy_projects', ['EnergyProject'])


    def backwards(self, orm):
        # Deleting model 'EnergyProject'
        db.delete_table(u'energy_projects_energyproject')
    ...
    models = {
        ...
        u'consumptions.consumption': {
            ...
            'volumetoenergyconversion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datasequences.EnergyPerVolumeDataSequence']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'energy_projects.energyproject': {
            'Meta': {'object_name': 'EnergyProject'},
            'baseline_from_date': ('django.db.models.fields.DateField', [], {}),
            'baseline_to_date': ('django.db.models.fields.DateField', [], {}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'energyproject_set'", 'null': 'True', 'to': u"orm['consumptions.Consumption']"}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '50'}),
            'result_from_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'result_to_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'time_datasource': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'energyproject_time_set'", 'null': 'True', 'to': u"orm['consumptions.Consumption']"})
        },
        u'energy_projects.ledlightproject': {
            'Meta': {'object_name': 'LedLightProject'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['customers.Customer']"}),
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['consumptions.Consumption']", 'null': 'True', 'blank': 'True'}),
            'encryption_data_initialization_vector': ('gridplatform.encryption.fields.Base64Field', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'led_consumption_per_tube': ('django.db.models.fields.IntegerField', [], {}),
            'led_tube_count': ('django.db.models.fields.IntegerField', [], {}),
            'name': ('gridplatform.encryption.fields.EncryptedCharField', [], {'max_length': '50'}),
            'previous_consumption_per_tube': ('django.db.models.fields.IntegerField', [], {}),
            'previous_tube_count': ('django.db.models.fields.IntegerField', [], {}),
