...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LedLightProject'
        db.create_table(u'energy_projects_ledlightproject', (
            ...
            ('previous_tube_count', self.gf('django.db.models.fields.IntegerField')()),
            ('previous_consumption_per_tube', self.gf('django.db.models.fields.IntegerField')()),
            ('led_tube_count', self.gf('django.db.models.fields.IntegerField')()),
            ('led_consumption_per_tube', self.gf('django.db.models.fields.IntegerField')()),
            ('price', self.gf('django.db.models.fields.FloatField')()),
            ('datasource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['consumptions.Consumption'], null=True, blank=True)),
        ))
        db.send_create_signal(u'energy_projects', ['LedLightProject'])


    def backwards(self, orm):
        # Deleting model 'LedLightProject'
        db.delete_table(u'energy_projects_ledlightproject')
